...
const Games = () => {
    ...
    const handleGameClick = (type) => {
        navigate(`/games/${type}`); // Navigate to the selected game type page
    };

    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-10">
            <h1 className="text-4xl font-bold mb-6">All Games</h1>
            <a href="https://snehacheckers.wishalpha.com/">Mine</a>
            <div className="grid grid-cols-3 gap-6">
                {games.map((game, index) => (
                    <motion.div
                        ...
                        onClick={() => handleGameClick(game.type)} // Add click handler
                    >
