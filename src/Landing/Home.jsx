...
import gameBg from "../../public/images/gamebg.jpg";
...
const Home = () => (
  <div
    className="min-h-screen bg-gray-900 text-white flex flex-col items-center py-10 bg-cover bg-center"
  ...
  >
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
      {games.slice(0, 3).map((game, index) => (
        ...
        >
          <img src={game.img} alt={game.title} className="w-full h-40 rounded-lg mb-4 object-cover" />
    ...
    <div className="mt-20 w-full max-w-6xl">
      ...
      <p className="text-lg text-gray-300 text-center max-w-2xl mx-auto">
        We are WishAlpha, a platform dedicated to bringing you the best gaming experience without the need for downloads. Our mission is to provide a wide variety of games, from action-packed adventures to brain-teasing puzzles, all in one place.
      </p>
    </div>
    ...
    <div className="mt-20 w-full max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { title: "Instant Play", desc: "No downloads required. Start playing instantly." },
          { title: "Wide Variety", desc: "Explore games across multiple genres." },
          { title: "Community", desc: "Compete and connect with players worldwide." },
        ].map((feature, index) => (
          <motion.div
            key={index}
            className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform flex flex-col items-center"
